...
en:{
  ...
  // Tabs
  introduction:'Introduction',design:'Design Considerations',floorplan:'Floor Plan',polycam:'Existing Space',enscape:'Enscape',selections:'Selection',presentation:'Presentation',estimates:'Estimates',
  // Dashboard
  ...
  eqFord:'Equipment: Ford Hotel Supply',eqSession:'Equipment: Session + Kitchen Mechanical',
  eqFordShort:'Equipment: Ford',eqSessionShort:'Equipment: Session',
  // Notes
  ...
  estTitle:'Budget Proposal (Options 1-3)',
  estSub:'Select one package first, then review original source bids below.',
  ...
  openDetail:'View Source Bids (A-D)',
  applyPreset:'Apply to Option B',
  applied:'Applied to Option B',
  resetRaw:'Reset Option B Raw',
  mapLabel:'Selection Mapping',
  sourceTitle:'Original Vendor Estimates (A-D)',
  sourceSub:'Raw contractor/equipment line items for detailed review and adjustment.',
...
ko:{
  ...
  eqFord:'장비: Ford Hotel Supply',eqSession:'장비: Session + Kitchen Mechanical',
  eqFordShort:'장비: Ford',eqSessionShort:'장비: Session',
  ...
  estSub:'먼저 패키지를 선택하고, 하단에서 원본 업체 견적을 상세 확인하세요.',
  ...
  openDetail:'원본 업체 견적 보기 (A~D)',
  applyPreset:'옵션 B에 적용',
  applied:'옵션 B 적용됨',
  resetRaw:'옵션 B 원본 복원',
  mapLabel:'선택 매핑',
  sourceTitle:'원본 업체 견적 상세 (A~D)',
  sourceSub:'시공/장비 원본 라인아이템을 상세 검토하고 필요 시 조정할 수 있습니다.',
  presNotes:'발표 메모',
...
const D = {
  ...
  b_gc:[
    ...
    {id:'b_floor1',name:'Alt #1: Kitchen Quarry Tile Floor',det:'Remove existing tile floor/base, install new 8x8 slip-resistant quarry tile + base',cost:9100,on:false},
  ...
  b_eq:[
    ...
    {id:'b_wso',name:'Open Shelving \u2014 Above Counter 4\u00d730"W + Above Sink 2\u00d772"W, 2\u00d730"W',det:'Wall-mounted SS shelving, $125 ea (30"W), $252 ea (72"W)',cost:1254,on:true,bv:'low'},
